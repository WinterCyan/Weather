...
import winter.weather.gson.Forecast;
import winter.weather.gson.Weather;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bingPicImg = findViewById(R.id.bing_pic_view);
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendHttpRequest(bingPicAddress, new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(WeatherActivity.this).load(picResponse).into(bingPicImg);
                    }
                });
            }
        });
    ...
    private void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=d0c136dfbdd047d09b114bce22db1382";
